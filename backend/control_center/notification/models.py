...
class Notifier(models.Model):
    ...
    def __str__(self):
        """
        Return a human-readable representation of the Notifier showing its user and phone number.
        
        Returns:
            str: Formatted as "Notifier for <username> (<phone_number>)".
        """
...
class Notification(models.Model):
    ...
    def __str__(self):
        """
        Provide a short human-readable representation of the notification.
        
        Returns:
            A string in the format "Notification for <username>: <first 20 characters of the message>".
        """
