...
export default function DeviceMonitoringPage() {
  ...
  const loadUptimeStatus = React.useCallback(async () => {
    ...
    try {
      ...
      setMonitoredDevices(
        allDevices.filter((d: { is_ping_target: boolean }) => d.is_ping_target)
          .length
      );
  ...
  const t = React.useCallback(
    (key: string) => getT(`deviceMonitoring.${key}`),
    [getT]
  );
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{monitoredDevices}</div>
                  <p className="text-xs text-muted-foreground">
                    {t("activeMonitoring")}
                  </p>
                </CardContent>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  View device uptime data in different formats and manage
                  monitoring settings
                </p>
              </div>
