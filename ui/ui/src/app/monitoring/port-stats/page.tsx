...
import PortUtilizationGraph from "@/components/graphs/PortUtilizationGraph";
import { useLanguage } from "@/context/languageContext";

export default function PortStatsPage() {
            ...
            <div className="flex items-center gap-2 px-4">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbItem>
                    <BreadcrumbLink href="/monitoring/port-stats">
                      {getT(
                        "page.PortUtilizationPage.page_title",
                        "Port Utilization"
                      )}
                    </BreadcrumbLink>
                  </BreadcrumbItem>
