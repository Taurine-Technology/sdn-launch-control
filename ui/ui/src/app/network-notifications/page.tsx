...
/**
 * Render the Network Notifications page with tabbed filters, pagination, and actions to view or mark notifications as read.
 *
 * The component synchronizes the active tab and page with the URL, loads notifications using a token from local storage,
 * and exposes actions to open a notification (which navigates to its detail and marks it read if necessary), mark a single
 * notification as read, and mark all notifications as read. It displays loading state, paginated results, urgency badges,
 * and a control to change pages.
 *
 * @returns A React element representing the network notifications page UI.
 */
...
/**
 * Top-level page that renders the network notifications content inside a Suspense boundary.
 *
 * The Suspense fallback displays a small loading placeholder while the content is resolving.
 *
 * @returns A React element containing a Suspense with NetworkNotificationsContent and a loading fallback.
 */
