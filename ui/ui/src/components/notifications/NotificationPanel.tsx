...
/**
 * Render a slide-out notification panel with tabs for unread, read, and all notifications, a refresh control, per-item and bulk "mark as read" actions, and a trigger showing unread count.
 *
 * The panel fetches and polls notification counts using a token from localStorage, updates its list when opened or refreshed, and navigates to a notification detail when an item is opened.
 *
 * @returns A React element containing the notification Sheet, its trigger button with unread badge, the tabbed notification list, and footer actions.
 */
