...
/**
 * Render a Sheet-based notification panel that displays network notifications with tabbed filters, live unread count, and actions to refresh, mark as read, or navigate to a notification's detail.
 *
 * @returns A JSX element containing:
 * - a bell trigger with an unread count badge,
 * - a left-side Sheet with tabs for Unread/Read/All and a refresh button,
 * - a scrollable list of notifications showing type, urgency, read state, description, and relative time,
 * - per-item and global "mark as read" actions, and
 * - a footer link to the full Network Notifications page.
 */
